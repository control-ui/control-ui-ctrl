...
packer({
    apps: {
        ctrlsProgressDemo: {
            ...
            rootSrc: 'demo/src',
            template: path.resolve(__dirname, 'packages', 'ctrls-progress/demo/public/index.html'),
            contentBase: path.resolve(__dirname, 'packages', 'ctrls-progress/demo/public'),
            port: 9230,
            main: path.resolve(__dirname, 'packages', 'ctrls-progress/demo/src/index.tsx'),
            dist: path.resolve(__dirname, 'dist', 'ctrls-progress-demo'),
            devServer: {
                client: {
                    overlay: false,
                    progress: false,
